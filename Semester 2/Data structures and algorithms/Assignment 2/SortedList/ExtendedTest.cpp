...
void testJumpBackward(Relation r)
{
    cout<<"Test Jump Backward"<<endl;
    SortedIteratedList list =SortedIteratedList(r);
    list.add(1);
    list.add(2);
    list.add(3);
    list.add(4);
    list.add(5);
    ListIterator it =list.search(5);
    it.jumpBackward(4);
    assert(it.getCurrent()==1);
    ListIterator it1=list.search(5);
    it1.jumpBackward(2);
    assert(it1.getCurrent()==3);
    try{
        it1.jumpBackward(5);
    }catch (exception&){
        assert(true);
