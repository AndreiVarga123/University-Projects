...
public class PrgState {
    ...
    public PrgState(MyIStack<Stmt> exeStack, MyIDict<String, Value> symTable, MyIList<Value> out, MyIDict<StringValue, BufferedReader> fileTable,MyIHeap<Integer,Value> memHeap,MyITable<Integer,Integer> lockTable, Stmt program) {
    ...
    public MyITable<Integer, Integer> getLockTable() {
        return lockTable;
    }
