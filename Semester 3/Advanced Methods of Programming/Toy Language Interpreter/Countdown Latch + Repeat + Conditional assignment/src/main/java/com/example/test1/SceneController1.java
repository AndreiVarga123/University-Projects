...
public class SceneController1 implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Stmt ex7 = new CompStmt(new VarDeclStmt("cnt", new IntType()),new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())), new CompStmt(new VarDeclStmt("v2", new RefType(new IntType())), new CompStmt(
                new VarDeclStmt("v3", new RefType(new IntType())), new CompStmt(new HeapAllocStmt("v1", new ValueExp(new IntValue(2))), new CompStmt(new HeapAllocStmt("v2", new ValueExp(new IntValue(3))),
                new CompStmt(new HeapAllocStmt("v3", new ValueExp(new IntValue(4))), new CompStmt(new NewLatchStmt("cnt", new rHExp(new VarExp("v2"))), new CompStmt(
                        new ForkStmt(new CompStmt(new wHStmt("v1", new ArithExp(3, new rHExp(new VarExp("v1")), new ValueExp(new IntValue(10)))), new CompStmt(
                                new PrintStmt(new rHExp(new VarExp("v1"))), new CompStmt(new CountDownStmt("cnt"), new ForkStmt(new CompStmt(new wHStmt("v2", new ArithExp(3, new rHExp(new VarExp("v2")), new ValueExp(new IntValue(10)))), new CompStmt(new PrintStmt(new rHExp(new VarExp("v2"))),
                                new CompStmt(new CountDownStmt("cnt"), new ForkStmt(new CompStmt(new wHStmt("v3",new ArithExp(3, new rHExp(new VarExp("v3")), new ValueExp(new IntValue(10)))), new CompStmt(
                                        new PrintStmt(new rHExp(new VarExp("v3"))), new CountDownStmt("cnt")
                                )))))))
                        )))
        ...
        Stmt ex8 = new CompStmt(new VarDeclStmt("a",new RefType(new IntType())),new CompStmt(new VarDeclStmt("b",new RefType(new IntType())),new CompStmt(new VarDeclStmt("v",new IntType()),new CompStmt(new HeapAllocStmt("a",new ValueExp(new IntValue(0))),new CompStmt(new HeapAllocStmt("b",new ValueExp(new IntValue(0))),new CompStmt(new wHStmt("a",new ValueExp(new IntValue(1))),new CompStmt(new wHStmt("b", new ValueExp(new IntValue(2))),new CompStmt(new ConditionalAssignmentStmt("v",new RelationalExp(1,new rHExp(new VarExp("a")),new rHExp(new VarExp("b"))),new ValueExp(new IntValue(100)),new ValueExp(new IntValue(200))),new CompStmt(new PrintStmt(new VarExp("v")),new CompStmt(new ConditionalAssignmentStmt("v",new RelationalExp(2,new ArithExp(2,new rHExp(new VarExp("b")),new ValueExp(new IntValue(2))),new rHExp(new VarExp("a"))),new ValueExp(new IntValue(100)),new ValueExp(new IntValue(200))),new PrintStmt(new VarExp("v"))))))))))));
