...
public class SceneController1 implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Stmt ex7 = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())), new CompStmt(new VarDeclStmt("v2", new RefType(new IntType())), new CompStmt(
                ...
                new CompStmt(new HeapAllocStmt("v3", new ValueExp(new IntValue(4))), new CompStmt(new NewBarrierStmt("cnt", new rHExp(new VarExp("v2"))), new CompStmt(
                        new ForkStmt(new CompStmt(new AwaitStmt("cnt"), new CompStmt(new wHStmt("v1", new ArithExp(3, new rHExp(new VarExp("v1")),new ValueExp(new IntValue(10)))), new PrintStmt(new rHExp(new VarExp("v1")))))),
                        new CompStmt(new ForkStmt(new CompStmt(new AwaitStmt("cnt"), new CompStmt(new wHStmt("v2", new ArithExp(3, new rHExp(new VarExp("v2")), new ValueExp(new IntValue(10)))),
                                new CompStmt(new wHStmt("v2", new ArithExp(3, new rHExp(new VarExp("v2")), new ValueExp(new IntValue(10)))), new PrintStmt(new rHExp(new VarExp("v2"))))))),
                                new CompStmt(new AwaitStmt("cnt"), new PrintStmt(new rHExp(new VarExp("v3")))))
                )))))
        )));

        Stmt ex8 = new CompStmt(new VarDeclStmt("a", new IntType()), new CompStmt(new VarDeclStmt("b", new IntType()), new CompStmt(new VarDeclStmt("c", new IntType()), new CompStmt(new AssignStmt("a", new ValueExp(new IntValue(1))),
                new CompStmt(new AssignStmt("b", new ValueExp(new IntValue(2))), new CompStmt(new AssignStmt("c", new ValueExp(new IntValue(5))),new CompStmt(
                        new SwitchStmt(new ArithExp(3, new VarExp("a"), new ValueExp(new IntValue(10))), new ArithExp(3, new VarExp("b"), new VarExp("c")), new CompStmt(new PrintStmt(new VarExp("a")), new PrintStmt(new VarExp("b"))),
