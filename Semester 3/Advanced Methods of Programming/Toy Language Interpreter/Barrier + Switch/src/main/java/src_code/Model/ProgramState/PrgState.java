...
public class PrgState {
    ...
    MyITable<Integer, Pair<Integer,ArrayList<Integer>>> barrierTable;
    Stmt originalProgram;
    int thread_id;
    static int id=0;

    public PrgState(MyIStack<Stmt> exeStack, MyIDict<String, Value> symTable, MyIList<Value> out, MyIDict<StringValue, BufferedReader> fileTable,MyIHeap<Integer,Value> memHeap,MyITable<Integer, Pair<Integer,ArrayList<Integer>>> barrierTable, Stmt program) {
    ...
    public MyITable<Integer, Pair<Integer, ArrayList<Integer>>> getBarrierTable() {
        return barrierTable;
    }
