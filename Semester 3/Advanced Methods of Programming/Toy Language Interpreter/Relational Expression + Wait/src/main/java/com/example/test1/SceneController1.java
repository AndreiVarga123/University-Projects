...
public class SceneController1 implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Stmt ex7 = new CompStmt(new VarDeclStmt("v", new IntType()), new CompStmt(new AssignStmt("v", new ValueExp(new IntValue(20))),
                new CompStmt(new WaitStmt(new IntValue(10)), new PrintStmt(new ArithExp(3, new VarExp("v"), new ValueExp(new IntValue(10)))))));


        Stmt ex8 = new CompStmt(new VarDeclStmt("v1", new IntType()), new CompStmt(new VarDeclStmt("v2", new IntType()), new CompStmt(
                new AssignStmt("v1", new ValueExp(new IntValue(2))), new CompStmt(new AssignStmt("v2", new ValueExp(new IntValue(3))), new CompStmt(
                new VarDeclStmt("a", new BoolType()), new CompStmt(new AssignStmt("a", new ValueExp(new BoolValue(true))),
