...
public class PrgState {
    ...
    public PrgState(MyIStack<Stmt> exeStack, MyIDict<String, Value> symTable, MyIList<Value> out, MyIDict<StringValue, BufferedReader> fileTable,MyIHeap<Integer,Value> memHeap, Stmt program) {
