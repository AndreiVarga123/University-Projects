...
public class PrgState {
    ...
    MyITable<Integer, Triple<Integer,ArrayList<Integer>,Integer>> semaphoreTable;
    Stmt originalProgram;
    int thread_id;
    static int id=0;

    public PrgState(MyIStack<Stmt> exeStack, MyIDict<String, Value> symTable, MyIList<Value> out, MyIDict<StringValue, BufferedReader> fileTable,MyIHeap<Integer,Value> memHeap,MyITable<Integer, Triple<Integer,ArrayList<Integer>,Integer>> semaphoreTable, Stmt program) {
    ...
    public MyITable<Integer, Triple<Integer, ArrayList<Integer>, Integer>> getSemaphoreTable() {
