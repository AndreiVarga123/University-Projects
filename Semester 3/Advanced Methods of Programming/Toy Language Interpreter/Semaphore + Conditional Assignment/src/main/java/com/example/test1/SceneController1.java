...
public class SceneController1 implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Stmt ex7 = new CompStmt(new VarDeclStmt("v1", new RefType(new IntType())), new CompStmt(new VarDeclStmt("cnt", new IntType()), new CompStmt(new HeapAllocStmt("v1", new ValueExp(new IntValue(2))),
                new CompStmt(new NewSemaphoreStmt("cnt", new rHExp(new VarExp("v1")), new ValueExp(new IntValue(1))), new CompStmt(
                        new ForkStmt(new CompStmt(new AcquireStmt("cnt"), new CompStmt(new wHStmt("v1", new ArithExp(3, new rHExp(new VarExp("v1")), new ValueExp(new IntValue(10)))), new CompStmt(
                                new PrintStmt(new rHExp(new VarExp("v1"))), new ReleaseStmt("cnt")
                        )))), new CompStmt(new ForkStmt(new CompStmt(new AcquireStmt("cnt"), new CompStmt(new wHStmt("v1", new ArithExp(3, new rHExp(new VarExp("v1")), new ValueExp(new IntValue(10)))),
                        new CompStmt(new wHStmt("v1", new ArithExp(3, new rHExp(new VarExp("v1")), new ValueExp(new IntValue(2)))), new CompStmt(
                                new PrintStmt(new rHExp(new VarExp("v1"))), new ReleaseStmt("cnt")
                        ))))), new CompStmt(new AcquireStmt("cnt"), new CompStmt(new PrintStmt(new ArithExp(2, new rHExp(new VarExp("v1")), new ValueExp(new IntValue(1)))), new ReleaseStmt("cnt"))))

                )))));


        Stmt ex8 = new CompStmt(new VarDeclStmt("b", new BoolType()), new CompStmt(new VarDeclStmt("c", new IntType()), new CompStmt(new AssignStmt("b", new ValueExp(new BoolValue(true))),
