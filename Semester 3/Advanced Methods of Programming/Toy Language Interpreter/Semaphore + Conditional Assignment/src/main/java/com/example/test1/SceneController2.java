...
public class SceneController2 {
    ...
    @FXML private TableView<Triple<Integer,Integer,String>> semaphoreTable;
    @FXML private TableColumn<Triple<Integer,Integer,String>,Integer> indexColumn;
    @FXML private TableColumn<Triple<Integer,Integer,String>,Integer> svalueColumn;
    @FXML private TableColumn<Triple<Integer,Integer,String>,String> threadColumn;
    private Stmt stmt;
    private PrgState pr;
    private IRepo repo;
    ...
    public void initScene()
    {
        ...
        indexColumn.setCellValueFactory(new PropertyValueFactory<Triple<Integer,Integer,String>,Integer>("first"));
        svalueColumn.setCellValueFactory(new PropertyValueFactory<Triple<Integer,Integer,String>,Integer>("second"));
        threadColumn.setCellValueFactory(new PropertyValueFactory<Triple<Integer,Integer,String>,String>("third"));
        id = 0;
    ...
    private void populateSemaphoreTable() {
        if(!ctrl.getPrgList().isEmpty()) {
            ...
            for (Map.Entry<Integer, Triple<Integer,ArrayList<Integer>,Integer>> r : ctrl.getPrgList().get(0).getSemaphoreTable().getSet()) {
                Triple<Integer,Integer,String> triple = new Triple<>(r.getKey(), r.getValue().getFirst()-r.getValue().getThird(),r.getValue().getSecond().toString());
                obsList.add(triple);
            }
            semaphoreTable.setItems(obsList);
