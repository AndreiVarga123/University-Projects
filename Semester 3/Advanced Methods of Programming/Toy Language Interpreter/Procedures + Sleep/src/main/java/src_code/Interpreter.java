package src_code;//package src_code;
//
...
//        */
//
//        MyIStack symTable1 = new MyStack(new Stack());
//        symTable1.push(new MyDict<>(new HashMap<>()));
...
//        PrgState pr1 = new PrgState(new MyStack<>(new Stack<>()),symTable1, new MyList<>(new ArrayList<>()), new MyDict<>(new HashMap<>()), new MyHeap<>(new HashMap<>()),new MyTable<>(new HashMap<>()), ex1);
//        ArrayList<PrgState> list1 = new ArrayList<>();
//        list1.add(pr1);
//        IRepo repo1 = new Repo(list1, "log1.txt");
//        Controller ctr1 = new Controller(repo1);
//
//        MyIStack symTable2 = new MyStack(new Stack());
//        symTable1.push(new MyDict<>(new HashMap<>()));
...
//        PrgState pr2 = new PrgState(new MyStack<>(new Stack<>()),symTable2,new MyList<>(new ArrayList<>()),new MyDict<>(new HashMap<>()),new MyHeap<>(new HashMap<>()),new MyTable<>(new HashMap<>()),ex2);
//        ArrayList<PrgState> list2 = new ArrayList<>();
//        list2.add(pr2);
//        IRepo repo2 = new Repo(list2,"log2.txt");
//        Controller ctr2 = new Controller(repo2);
//
//        MyIStack symTable3 = new MyStack(new Stack());
//        symTable1.push(new MyDict<>(new HashMap<>()));
...
//        PrgState pr3 = new PrgState(new MyStack<>(new Stack<>()),symTable3,new MyList<>(new ArrayList<>()),new MyDict<>(new HashMap<>()),new MyHeap<>(new HashMap<>()),new MyTable<>(new HashMap<>()),ex3);
//        ArrayList<PrgState> list3 = new ArrayList<>();
//        list3.add(pr3);
//        IRepo repo3 = new Repo(list3,"log3.txt");
//        Controller ctr3 = new Controller(repo3);
//
//        MyIStack symTable4 = new MyStack(new Stack());
//        symTable1.push(new MyDict<>(new HashMap<>()));
...
//        PrgState pr4 = new PrgState(new MyStack<>(new Stack<>()),symTable4,new MyList<>(new ArrayList<>()),new MyDict<>(new HashMap<>()),new MyHeap<>(new HashMap<>()),new MyTable<>(new HashMap<>()),ex4);
//        ArrayList<PrgState> list4 = new ArrayList<>();
//        list4.add(pr4);
//        IRepo repo4 = new Repo(list4,"log4.txt");
//        Controller ctr4 = new Controller(repo4);
//
//        MyIStack symTable5 = new MyStack(new Stack());
//        symTable1.push(new MyDict<>(new HashMap<>()));
...
//        PrgState pr5 = new PrgState(new MyStack<>(new Stack<>()),symTable5,new MyList<>(new ArrayList<>()),new MyDict<>(new HashMap<>()),new MyHeap<>(new HashMap<>()),new MyTable<>(new HashMap<>()),ex5);
//        ArrayList<PrgState> list5 = new ArrayList<>();
//        list5.add(pr5);
//        IRepo repo5 = new Repo(list5,"log5.txt");
//        Controller ctr5 = new Controller(repo5);
//
//        MyIStack symTable6 = new MyStack(new Stack());
//        symTable1.push(new MyDict<>(new HashMap<>()));
...
//        PrgState pr6 = new PrgState(new MyStack<>(new Stack<>()),symTable6,new MyList<>(new ArrayList<>()),new MyDict<>(new HashMap<>()),new MyHeap<>(new HashMap<>()),new MyTable<>(new HashMap<>()),ex6);
